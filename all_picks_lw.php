...
$thequery="SELECT pyu_bets.USER, pyu_games.AWAY, pyu_games.HOME, pyu_bets.BETTYPE, pyu_bets.POINTS, pyu_bets.UNITS FROM pyu_bets JOIN pyu_games ON pyu_bets.gid = pyu_games.gid WHERE pyu_games.WEEK = CurrentWeek()-1 ORDER BY pyu_bets.USER ASC , pyu_bets.UNITS DESC";
